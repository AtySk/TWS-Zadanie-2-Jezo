const hero = document.getElementById("filter-photo");
const images = ["../fotky/H2R.jpg", "../fotky/Yamaha1.jpg"];
let current = 0;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function showModal(index) {
    ...
    modal.style.display = "flex"; // zmenené z triedy
  }
